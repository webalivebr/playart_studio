...
---------------------------------------------------*/	
	...
	function CleanupBeforeAjax(){		
        ...
        function adicionarImagensNaLista() {
			var imagens = [];


        for (var i = 1; i <= 30; i++) {
            var url = "images/outros/outros" + ("0" + i).slice(-2) + ".jpg";
            imagens.push(url);
        }
            console.log("passei a pica no bruno")
            var listaHTML = document.getElementById('lista-imagens');
